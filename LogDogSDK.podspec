Pod::Spec.new do |s|
    ...
    s.source           = { :http => 'https://log-dog-ios-sdk.s3.eu-central-1.amazonaws.com/log-dog-ios-sdk.xcframework.zip' }
    #s.source          = { :http => 'https://github.com/modrena/log-dog-ios-sdk/releases/download/v1.4.453/log-dog-ios-sdk.xcframework.zip' }
