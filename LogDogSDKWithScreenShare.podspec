Pod::Spec.new do |s|
    ...
    s.version          = '1.4.508' # or your desired version
    ...
    s.source           = { :http => 'https://github.com/modrena/log-dog-ios-sdk/releases/download/v1.4.502/log-dog-ios-sdk-with-webrtc.xcframework.zip' }
    s.vendored_frameworks = 'LogDogWithScreenShare.xcframework'
    s.platform         = :ios, '15.0'
    s.swift_version    = '5.7'
