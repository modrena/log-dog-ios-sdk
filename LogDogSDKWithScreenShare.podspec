Pod::Spec.new do |s|
    ...
    s.version          = '1.4.501' # or your desired version
    ...
    s.source           = { :http => 'https://github.com/modrena/log-dog-ios-sdk/releases/download/v1.4.501/log-dog-ios-sdk-with-webrtc.xcframework.zip' }
